...
INSERT INTO `organization` VALUES (1,'Epolet','Place for family',2,1,NULL,5,NULL),(2,'Дежурная аптека аптека','Всегда открыта',2,2,NULL,6,NULL),(3,'Аптека №2','Редкие лекарства',2,1,NULL,6,0),(4,'Фитоаптека','Лекарства на растительных основах',2,2,NULL,6,0),(5,'Поликлиника №4',NULL,2,2,NULL,7,0);
...
-- Dump completed on 2015-04-11 18:23:26
