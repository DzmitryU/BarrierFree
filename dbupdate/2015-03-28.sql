...
START TRANSACTION;
USE `bfree`;
INSERT INTO `bfree`.`coordinate` (`id`, `x`, `y`) VALUES (1, 53, 23);
INSERT INTO `bfree`.`coordinate` (`id`, `x`, `y`) VALUES (2, 53.3, 24);
...
START TRANSACTION;
USE `bfree`;
INSERT INTO `bfree`.`organization` (`id`, `name`, `description`, `user_id`, `coordinate_id`, `image`, `Category_id`) VALUES (1, 'Epolet', 'Place for family', 2, 1, NULL, 5);
INSERT INTO `bfree`.`organization` (`id`, `name`, `description`, `user_id`, `coordinate_id`, `image`, `Category_id`) VALUES (2, 'Дежурная аптека аптека', 'Всегда открыта', 2, 2, NULL, 6);
